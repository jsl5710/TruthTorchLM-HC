# Paper 1 — Distilled-proxy black-box UQ

*"Read-Out, Not Objective: A Latency-First Benchmark of Pure Black-Box Uncertainty
Quantification with Distilled Proxies."*
