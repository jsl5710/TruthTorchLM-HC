...
and the read-out (\texttt{edl}/\texttt{head}) define the \ours\ variant grid; the full grid is in
Appendix~\ref{app:variants}, and a single-target oracle sweep in Appendix~\ref{app:rq5}.
...
\paragraph{Teacher and scale dependence.} (Six-student sweep: Appendix~\ref{app:students}.) On frontier API teachers the picture shifts
