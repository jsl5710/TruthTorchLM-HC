...
``oracle ceiling'' is unreachable. What survives is a clear recommendation:
...
\node[font=\scriptsize, anchor=south, align=center] at (axis cs:700,0.640)
  {$\approx$0.03 AUROC\\for $250\times$ latency};
\end{axis}
\end{tikzpicture}
...
target generation and $N{=}10$ consistency pays ten. The proxy gives up $\approx$0.03 AUROC
