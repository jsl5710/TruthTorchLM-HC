...
on Qwen without significance ($p{=}0.107$). We also run the multi-sample baselines there rather
than assuming them impractical: they match $n_7$ at $N{=}5$ and overtake it only at $N{=}10$,
i.e.\ ten full resamples of a $180$-word answer against our one. Reporting confidence intervals
throughout, we find this design resolves only differences above ${\sim}0.15$ AUROC and label the
rest inconclusive. The recommendation is
...
baselines require resampling a $180$-word answer $N$ times; we pay that cost and show they need
$N{=}10$ to edge past our single-answer estimator, by margins inside our confidence intervals.
...
multi-sample methods cost ten full resamples of the answer to pull marginally ahead. Everywhere
...
one regime where multi-sample baselines must resample the entire answer to compete. The direction replicates
