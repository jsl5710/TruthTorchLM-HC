...
nothing beyond $n_4$, and the $n_4{\to}n_5$ comparison should not be read as an ablation.
...
as a loss for decomposition. $n_4$ never beats $n_3$ by more than $0.002$. Splitting or re-rating the chain does not help; only the discriminative read
