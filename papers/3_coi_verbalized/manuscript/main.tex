...
\paragraph{Author spot-check (to be completed).} We release a random sample of $100$ labelled
items with all three judges' votes (\texttt{judge\_spotcheck\_sample.jsonl}) for manual
verification by the authors. \textbf{[Placeholder: report human--judge agreement on the
$100$-item sample here once the manual pass is complete.]}
