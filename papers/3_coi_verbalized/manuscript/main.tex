...
\item \textbf{The data type, not the model, decides which estimator wins.} Over $38$
non-degenerate model$\times$dataset cells, verification is best in $9$; the two baselines take
$23$. The structure is sharp when read by data type: verification wins \emph{both} long-form
general-knowledge cells and \emph{none} of the fourteen health cells---MCQ, free-form and
long-form alike---across 8B, 32B, 70B and frontier closed targets. The blanket claim
``decomposition beats verbalized confidence'' is false, and we report this as our primary
finding.
...
\midrule
General, short-form & 10 & 1 & 1 & 4 & 1 & 2 & 1 & 3/10 \\
General, long-form  &  2 & 0 & 0 & 0 & 0 & 0 & 2 & \textbf{2/2} \\
Adversarial         &  6 & 1 & 1 & 2 & 0 & 1 & 1 & 2/6 \\
Health, MCQ         &  8 & 5 & 1 & 2 & 0 & 0 & 0 & \textbf{0/8} \\
Health, free-form   &  3 & 1 & 0 & 2 & 0 & 0 & 0 & \textbf{0/3} \\
Health, long-form   &  3 & 2 & 1 & 0 & 0 & 0 & 0 & \textbf{0/3} \\
Math                &  4 & 0 & 0 & 3 & 0 & 0 & 1 & 1/4 \\
Multi-hop           &  2 & 0 & 0 & 0 & 1 & 0 & 1 & 1/2 \\
\midrule
\textbf{Total}      & \textbf{38} & 10 & 4 & 13 & 2 & 3 & 6 & \textbf{9/38} \\
\bottomrule
\end{tabular}
...
\textbf{none} of the fourteen health cells, while the two baselines ($n_1$ verbalized, $n_3$
$\phi$) take $23$ of $38$ overall. The dataset predicts the winner far better than the target
model does.}
\label{tab:groups}
\end{table}

\subsection{The winner is determined by the data type, not the model}\label{sec:minority}
Table~\ref{tab:groups} aggregates the full $6\times12$ grid by data type. Three patterns hold
across every target we tested.
...
blanket claim ``decomposed verification beats verbalized confidence'' is false, and we report
that as our primary finding. We also note that a rung we might have discarded, $n_2$ (per-claim
